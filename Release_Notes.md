...
1. [Download the vault](https://github.com/doctorfree/Obsidian-Custom-Discogs/archive/refs/tags/v1.0.2r4.tar.gz)
2. Extract the vault: `tar xf /path/to/Obsidian-Custom-Discogs-1.0.2r4.tar.gz`
...
```shell
wget --quiet -O ~/Downloads/Obsidian-Custom-Discogs-v1.0.2r4.tar.gz \
  https://github.com/doctorfree/Obsidian-Custom-Discogs/archive/refs/tags/v1.0.2r4.tar.gz
```
...
unzip /path/to/Obsidian-Custom-Discogs-1.0.2r4.zip
```
...
tar xf /path/to/Obsidian-Custom-Discogs-1.0.2r4.tar.gz
```

Once extracted, the Obsidian Custom Discogs vault is now available in `/path/to/your/vaults/Obsidian-Custom-Discogs-1.0.2r4/`.

The downloaded archive can be deleted:

```shell
rm -f /path/to/Obsidian-Custom-Discogs-1.0.2r4.zip
```

or

```shell
rm -f /path/to/Obsidian-Custom-Discogs-1.0.2r4.tar.gz
```
...
Add a new vault in Obsidian with `Open folder as vault` and navigate to the `Obsidian-Custom-Discogs-1.0.2r4` extracted folder. When prompted, `Trust` and enable the `Dataview` plugin if it is not already enabled.
...
```shell
cd /path/to/your/vaults # e.g. `cd ~/Documents/Obsidian`
rm -rf Obsidian-Custom-Discogs-1.0.2r4
```
...
View the full changelog for this release at https://github.com/doctorfree/Obsidian-Custom-Discogs/blob/v1.0.2r4/CHANGELOG.md
