...
- [Download the vault](https://github.com/doctorfree/Obsidian-Custom-Discogs/archive/refs/tags/v1.0.2r4.tar.gz)
- Extract the vault: `tar xf /path/to/Obsidian-Custom-Discogs-1.0.2r4.tar.gz`
